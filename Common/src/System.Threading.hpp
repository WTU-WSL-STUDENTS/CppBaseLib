...
namespace System
{
    namespace Threading /* https://docs.microsoft.com/zh-cn/dotnet/api/system.threading.thread?view=net-5.0 */
    {
            ...
            public:
                ...
                Thread(THREAD_EVENT func, THREAD_EVENT_ARGS args, ThreadPriorty priorty = Normal)
                {
                    ...
                    tInfo.Priorty   = priorty;
                        ...
                        {
                            tInfo.CurrentStatus = TRUE == SetThreadPriority(tInfo.Handle, tInfo.Priorty) ? NotInit : Created;
                        }
                        else
                        {
                            tInfo.CurrentStatus = NotInit;
