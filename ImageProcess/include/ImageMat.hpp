 ...
 * @LastEditors: like
 * @LastEditTime: 2021-10-07 10:33:48
 */
...
inline void  DecomposeMatKernel555(const MatKernel16Bit& val, ColorBGR& pixel)
{
    pixel = {(CV_BYTE)(val & 0x001f), (CV_BYTE)(val & 0x03e0), (CV_BYTE)(val & 0x7c00)};
}
/* 565的调色盘的位置包含掩码 3*4 ~ 4*4个字节*/
inline void  DecomposeMatKernel565(const MatKernel16Bit& val, ColorBGR& pixel)
{
    pixel = {(CV_BYTE)(val & 0x001f), (CV_BYTE)(val & 0x07e0), (CV_BYTE)(val & 0xf800)};
}
/* 1,5,5,5的 BGRA,有2^5 * 2^5 * 2^5个调色盘 */
inline void  DecomposeMatKernel1555(const MatKernel16Bit& val, ColorBGRA& pixel)
{
